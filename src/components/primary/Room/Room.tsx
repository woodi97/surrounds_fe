...
export default function Room(props: IRoomProps): JSX.Element {
  const { className, chatroom, emailId, profileImage, currentLocation, getChatRooms, onClick } =
    props
    ...
    <div className={classNames(className, styles.container)}>
      <div className={styles.header}>
        <div className={styles.header_infos}>
          ...
          <div className={styles.header_infos_location}>{/* 흑석로, 중앙대학교(5m) */}</div>
        </div>
        <div className={styles.header_buttons}>
          <img onClick={onExitButtonClick} src="/images/icon_exit.svg" alt=""></img>
        </div>
      </div>
