...
export default function LandingPage(): JSX.Element {
	...
	const revealScrolls = useCallback((ScrollReveal) => {
		...
		const deviceMockup: IDeviceMockUp =
		...
		function featuresTitlePos() {
			const featuresSectionLeft = featuresSection
				.querySelector(".features-inner")
				.getBoundingClientRect().left;
			const firstFeatureLeft = firstFeature.getBoundingClientRect().left;
			const featuresTitleOffset = firstFeatureLeft - featuresSectionLeft;
		...
		function moveObjects(e, object) {
			...
			for (let i = 0; i < object.length; i++) {
				...
				if (
					...
					const strTranformProperty = tranformProperty.join(" ");
						...
						<div className="container">
							<div className="hero-inner">
								<div className="hero-copy">
									<h1 className="hero-title mt-0">Chat with Neighbors</h1>
				...
				<footer className="site-footer">
					<div className="container">
						<div className="site-footer-inner has-top-divider">
							...
							<div className="footer-copyright">&copy; 2021 Surrounds</div>
						</div>
					</div>
				</footer>
			</div>
